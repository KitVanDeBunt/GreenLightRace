...
public class TrackSettings{
    ...
    public Material TrackMaterialWalls;
    public Material TrackMaterialBottom;
    ...
    public float wallXDisplaysment = 0.5f;
	...
	public bool CheckUpdated(){
        ...
        if(TrackMaterialWalls		!= save.TrackMaterialWalls){
			return true;
		}
        if(TrackMaterialBottom		!= save.TrackMaterialBottom){
			return true;
		}
        ...
        if (wallXDisplaysment != save.wallXDisplaysment)
        {
            return true;
        }
	...
	public void Save(){
        ...
        save.TrackMaterialWalls = TrackMaterialWalls;
        save.TrackMaterialBottom = TrackMaterialBottom;
        ...
        save.wallXDisplaysment = wallXDisplaysment;
